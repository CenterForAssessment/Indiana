...
tmp.math <- Indiana_SGP_WIDE_Data[,c("ID", "SGP_LEVEL_COVID_IMPACT.2022.MATHEMATICS", "SGP_TARGET_BASELINE_RECOVERY_4_YEAR.2022.MATHEMATICS")][,CONTENT_AREA:="MATHEMATICS"][,VALID_CASE:="VALID_CASE"][,YEAR:="2022"][!is.na(SGP_LEVEL_COVID_IMPACT.2022.MATHEMATICS) | !is.na(SGP_TARGET_BASELINE_RECOVERY_4_YEAR.2022.MATHEMATICS)]

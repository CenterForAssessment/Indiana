###########################################################################################
###
### Script for creating Indiana LONG data set for 2014
###
###########################################################################################
...
ELA_Data <- read.csv("Data/Base_Files/GrowthModel_File_ELA_2014.csv")
MATH_Data <- read.csv("Data/Base_Files/GrowthModel_File_MATH_2014.csv")
...
tmp_Data[which(duplicated(tmp_Data, by=key(tmp_Data)))-1, VALID_CASE := "INVALID_CASE"]
...
Indiana_Data_LONG_2014 <- tmp_Data
...
setcolorder(Indiana_Data_LONG_2014, variable.names)


### Save result

save(Indiana_Data_LONG_2014, file="Data/Indiana_Data_LONG_2014.Rdata")

...
SGPstateData <- addBaselineMatrices("IN", "2022")
...
IN_CONFIG <- c(ELA_2022.config, MATHEMATICS_2022.config)
...
Indiana_SGP <- updateSGP(
        ...
        with_sgp_data_LONG = Indiana_Data_LONG_2022,
